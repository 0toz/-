...
<body>
	<div >
		<section class="header">
			<div class="header">
				<div class="container">
					<div style="float: left; margin-right: auto; margin-left: auto; border: 4px solid lightgray; width : 10%" >
						<a href="">	<img alt="유투뷰 로고" src="../image/유투뷰 로고.png" width="100%" height="100%"></a>
					</div>
					<div style="float: left; margin-right: auto; margin-left: auto; border: 4px solid red; width : 50%">
						 <form>검색 :
						<input type= "text"> 
						</form>
					</div>
					<div style="float: right; margin-right: auto; margin-left: auto; border: 4px solid blue; width : 20%">
						<a href="">Log In</a>
					</div>
		...
		<div class="contents">
			<div class="container">
				...
				<div class="bodybox">
						...
						<table style="width: 100%; border: 4px solid lightgray; background-color: white; padding: 50px; font-weight: bold; font-size: 20px;">
								<tr>
					...
					<div style=" width: 100%; padding: 1px; font-weight: bold; font-size: 20px;">
						...
						<a href=""><img alt="카카오로그인" src="../image/구글 로그인.png" width="100%" height="100%"></a>
						</div>
						<div  style="float: right;	margin-right: auto;	margin-left: auto;">
						<a href=""> <img alt="구글로그인" src="../image/카카오톡 로그인.png" width="100%" height="100%"></a>
						</div>
					</div>
